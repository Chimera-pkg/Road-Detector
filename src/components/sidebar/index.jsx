...
const Sidebar = ({ open, onClose }) => {
  return (
    <div
      className={`bg-blue-700 duration-175 linear fixed flex min-h-full flex-col bg-white  shadow-2xl shadow-white/5 transition-all dark:!bg-navy-800 dark:text-white md:!z-50 lg:!z-50 xl:!z-0 ${
